...
function Check_display() {
    ...
    // ==========================================
    let strictSchedule = {
        "07:15": "ねむ～。忘れ物してない？財布、スマホ、鍵！ちゃんと確認してよね！",
        "07:45": "そろそろ家出る時間でしょ！？エアコン消した？！電気消した？！",
        "08:15": "もう電車の中？傘ちゃんともってってるよね？",
        "21:30": "ほら、もう21時半だよ！早くお風呂入ってよ！風呂キャン禁止！",
        "23:45": "夜更かし禁止！スマホ置いて早く寝ろーー！"
    };
    ...
    if (isWeatherEnabled && currentHour === 7 && cachedWeather) {
        ...
        if (cachedWeather.status === "雨") {
            ...
            weatherTalks = [
                "おはよ！外めっちゃ雪降ってるよ！☃️ 滑らないように気をつけて！",
                "え、雪じゃん！激寒なんだけど！超あったかくして出かけなよ？"
            ];
        }
    ...
    if (cachedWeather && (Date.now() - cachedWeather.updatedAt < 3600000) && !cachedWeather.isError) {
        ...
        if (cachedWeather.isHome) {
            ...
            if (currentHour >= 19 && currentHour <= 20) {
                let homeTalks = [
                    "おかえりー！今日も一日お疲れ様。家着いたなら早く部屋着に着替えなよ〜？",
                    "お疲れ～超疲れたっしょ！ゆっくり休みなよ～",
                    "今日も頑張ったじゃん！偉い偉い。早く手洗いとうがいしなよ？"
                ];
            ...
            if (currentHour >= 11 && currentHour <= 13) {
                let outNoonTalks = [
                    "今外にいるんだ？ちゃんと鍵閉めてきた？泥ギフト入らないか心配なんだけど！",
                    "今日は何食べた？私ラーメン食べてきたよ～",
                    "外でお仕事中？お出かけ？水分補給ちゃんとしなよー！"
                ];
            ...
            if (currentHour >= 22 || currentHour <= 1) {
                let outNightTalks = [
                    "ちょっと、もう夜遅いよ！？まだ外にいるの？早くお家に帰りなさい！",
                    "こんな時間まで何してるの？早く帰ってきな！",
                    "夜道危ないから気をつけてね？寄り道しないで真っ直ぐ帰るんだよー！"
                ];
    ...
    // ==========================================
    let weekdaySchedule = [
        { start: 5,  end: 6,  talks: ["おはよう！今日もお仕事だよね？がんばって～！", "ゆっくり休めた？", "ねむ～。忘れ物してない？財布とかスマホとか。ちゃんと確認してよね～"] },
    ...
    let weekendSchedule = [
        ...
        { start: 13, end: 17, talks: ["ちゃんと部屋掃除してる？やばいからね！？", "洗濯機回してる～？早く回しなよ～", "炊飯器放置してないよね？！", "冷蔵庫の物、腐らせたりしてないよね？！", "ゴミたまってない？ちゃんとまとめて出しなよ！"] },
        { start: 18, end: 20, talks: ["夜ごはん食べた？食べないとだめだよ！", "あたし夜ごはんハンバーグだった！", "食べた後皿洗った？"] },
        { start: 21, end: 22, talks: ["早くお風呂入ってよ～？", "まさか風呂キャン…じゃないよね？"] },
        { start: 23, end: 10, talks: ["スマホばっかやってないよね？早く寝ろ！！", "早く寝ないと健康に悪いぞー", "夜更かししてないで明日のために寝よう！", "ベッドに入って目を閉じなよ～", "すやすや…", "そろそろ朝になっちゃよ？"] }
    ];
    ...
    if (hourlyTalks && hourlyTalks.length > 0) {
        ...
        taskTalkElement.textContent = "すやすや…（休日はゆっくり過ごそう）";
    }
}